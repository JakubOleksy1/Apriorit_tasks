...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        folderPathLineEdit->setObjectName("folderPathLineEdit");

        verticalLayout->addWidget(folderPathLineEdit);
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "File Browser", nullptr));
